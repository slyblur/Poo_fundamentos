...
public class clienteCLASS {
	...
	String nomecompleto, endereco, email;
	int telefone, idade;
	char genero;
	boolean maiorde18;
	...
	public clienteCLASS(String nomecompleto, String endereco, String email, int telefone, int idade, char genero,
			boolean maiorde18) {
		super();
	...
	public clienteCLASS(String nomecompleto, int idade, char genero, boolean maiorde18) {
		super();
		this.nomecompleto = nomecompleto;
		this.idade = idade;
		this.genero = genero;
